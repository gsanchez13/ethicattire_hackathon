...
const Shops = () => {
  return (
    ...
    <div className="main">
      ...
      <div className="storePicDiv">
        <img src="https://lsco.scene7.com/is/image/lsco/levis/clothing/295020142-front-pdp.jpg?$thumb_desktop$" alt="levis"></img>{" "}
      </div>
      
      <div className="storeInfoDiv">
        <a href="https://www.levi.com/US/en_US/" target="_blank" rel="noopener noreferrer">
          Levis
        </a>{" "}
        <p>
      ...
      <div className="storeInfoDiv">
        <img src="https://www.alternativeapparel.com/media/catalog/product/0/1/01970E1ECOATL0_2.jpg" alt="alternative-apparel"></img>
        <br />
        <a href="https://www.alternativeapparel.com/" target="_blank" rel="noopener noreferrer">
          Alternative Apparel
        </a>{" "}
        <p>
      ...
      <div className="storeInfoDiv">
        <img src="https://static.wearpact.com/img/product/women/wtw-frn-1-1582139939.jpg" alt="target"></img>
        <br />
        <a href="https://wearpact.com/" target="_blank" rel="noopener noreferrer">
          Pact
        </a>
        <p>
      ...
      <div className="storeInfoDiv">
        <img src="https://media.thereformation.com/image/upload/q_auto:eco/c_scale,w_auto:breakpoints_100_2560_9_20:632/v1/prod/product_images/ruskin-top/avocado/5e52cb0c8130bc5051f985ad/original.jpg" alt="thereformation"></img>
        <br />
